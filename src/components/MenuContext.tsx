...
const MenuContext = () => {
    ...
    return (
        <div style={{ "display": value, "top": `${menustate.y}px`, "left": `${menustate.x}px` }} className="z-20 absolute bottom-0 bg-[#252525] rounded-md w-[210px] flex flex-col gap-2 items-center w-[100px] h-[220px] overflow-hidden" >
            {
                data.map((value) => {
